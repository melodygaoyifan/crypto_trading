...
from integration.core.market_regime_v32 import EnhancedRegimeState, MarketRegimeState, OpportunityMode
...
class SOLExposureManager:
    ...
    def calculate_target_exposures(
        self,
        btc_intent: Optional[TradeIntent],
        eth_intent: Optional[TradeIntent],
        sol_intent: Optional[TradeIntent],
        regime_state: EnhancedRegimeState,
        flow_alignment: float = 0.0
    ) -> Dict[str, float]:
        """
