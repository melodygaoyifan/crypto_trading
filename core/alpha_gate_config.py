...
class AlphaGateSettings:
    ...
    quiet_accum_min_direction: float = 0.08       # [UTIL-2] was 0.35→0.15→0.08. 0.15 blocked mean_revert (typical dir 0.10-0.15 in QUIET_ACCUM)
    quiet_accum_min_direction_by_asset: Dict[str, float] = field(default_factory=dict)
    quiet_accum_min_direction_short: float = 0.08  # [UTIL-2] was 0.35→0.15→0.08
