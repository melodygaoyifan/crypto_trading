...
- **Tests:** `tests/test_coinbase_protective_stop.py` (23). Falsification-checked: removing the adapter STOP branch fails 7; removing the flat-cancel branch fails the orphan test.
