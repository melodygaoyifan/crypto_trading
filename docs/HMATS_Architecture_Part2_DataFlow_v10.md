...
> **⚠️ 历史文档（标注于 2026-08-07）。** 本文冻结于 2026-02-28，描述的机制框架
> 仍有参考价值，但以下运行时事实已过时：**执行 venue 已是 Coinbase US perps
> sleeve（2026-06-13 起，Kraken 结构性无仓，P152）**；**DRL(TQC) 已降级 SHADOW
> 并被 fusion 排除（2026-08-07，P198）**；authority matrix 现为 26 agents / 6
> 类权限（非本文的 5 agents / 4 类）。当前真实状态以 **CLAUDE.md** 为准。
